...
public class Popup extends JFrame implements ActionListener {
	...
	public Popup() {
		...
		txtLastData
				.setBorder(new CompoundBorder(new LineBorder(new Color(216, 216, 216)), new EmptyBorder(4, 5, 0, 5)));
		...
		// TODO: comboTags.setModel(new DefaultComboBoxModel<String>(new String[]
		// {"working", "studing", "relax", "working in own project", "offline"}));
		...
		txtDescription.setBorder(
				new CompoundBorder(new LineBorder(new Color(187, 187, 187)), new EmptyBorder(10, 10, 10, 10)));
