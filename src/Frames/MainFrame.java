...
public class MainFrame extends JFrame implements ActionListener {
	...
	public MainFrame() {
		...
		txtHistorial
				.setBorder(new CompoundBorder(new LineBorder(new Color(187, 187, 187)), new EmptyBorder(6, 6, 6, 6)));
		...
		comboTime.setModel(new DefaultComboBoxModel<String>(new String[] { "15 min", "20 min", "25 min", "30 min",
		...
		textFieldTag
				.setBorder(new CompoundBorder(new LineBorder(new Color(187, 187, 187)), new EmptyBorder(0, 4, 0, 4)));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnStart) {
			...
			MyItems currenItems = (MyItems) comboTags.getSelectedItem();
			if (currenItems == null)
				return;

			String operation = comboOperations.getSelectedItem().toString();

			if (operation == UPDATE || operation == DELETE) {
				textFieldTag.setText(currenItems.toString());
				txtTemplate.setText(currenItems.getTemplate().replace("\\n", "\n"));
			}
